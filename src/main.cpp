...
=======
    if (240 > Optical.hue() && Optical.hue() > 220 && isRed){
>>>>>>> Stashed changes
      if (lbState == 1){
        lbBack = true;
        lbState = 2;
...
void soloAWP(){
  ...
  Drive.moveDistance(2.3, 100, .3); // 2.35 for metal field
  ...
  task clamp1 = task(fasterClamping);
  Drive.moveDistance(-12, 50, .8);
  Drive.turn(-170, 100, .7);
  intake.spin(fwd, 100, pct);
  wait(.2, sec);
  Drive.moveDistance(23,90, .9);
  intake.stop();
  Drive.turn(15, 90, .85);

  task longDriveIntCont = task(stopIntBSAWP);
  Drive.moveDistance(74, 100, 1.8);
  Drive.turn(-45, 100, .7);
  clamp.close();
  intake.spin(fwd, 60, pct);
  Drive.moveDistance(29.2 , 100, 1);
  intake.stop();
  Drive.turn(0, 100, .5);
  task clamp2 = task(fasterClamping2);
  Drive.moveDistance(-26, 80, 1);
  intake.spin(fwd, 100, pct);
  Drive.turn(-135, 100, .75);
  lbState = 1;
...
void blueSoloAWP(){
  ...
  clamp.close();
  intake.spin(fwd, 60, pct);
  Drive.moveDistance(25.2 , 100, 1);
  Drive.turn(0, 100, .5);
  intake.stop();
  task clamp2 = task(fasterClamping2);
  Drive.moveDistance(-24, 80, 1);
  intake.spin(fwd, 100, pct);
  Drive.turn(-135, 100, .75);
  lbState = 1;
  task ringOne1 = task(ladyBrownMechScoring);
...
void blueNeg(){
  ...
  intake.spin(fwd, 100, pct);
  wait(.5, sec);
  Drive.swing(12, 80, 162, 1);
  task intStop = task(stopIntBNeg);
  Drive.moveDistance(33.3, 100, 1.2);
  intake.stop();
  wait(.1, sec);
  Drive.turn(236, 100, .8);
  task clamp1 = task(fasterClamping);
  Drive.moveDistance(-12, 50, .8);
  Drive.turn(173, 100, .7);
  intake.spin(fwd, 100, pct);
  wait(.2, sec);
  Drive.moveDistance(21,90, .9);
  Drive.turn(15, 100, .9);
  wait(2, sec);
...
void redPosElim(){
  ...
  clamp.close();
  Drive.moveDistance(37.5, 100, 1.2);
...
void tester(){
  ...
  Drive.moveDistance( -16.746478873027158 , 100 , .9 );	
  ...
  intakeLift.close();
  intake.stop();
  Drive.turn( 122 , 100 , .8 );	
  Drive.moveDistance( 17.15492957724733 , 100 , .9 );	
  Drive.turn( -90 , 100 , 1.00000009 );	
  Drive.moveDistance( 18.380281689907854 , 100 , .9 );	
  Drive.turn( 0 , 100 , 1.00000009 );	
  Drive.moveDistance( -4.0845070422017455 , 100 , .4 );	
  intake.spin(fwd, 100, pct);
  wait(.6, sec);
  intake.stop();
  Drive.moveDistance( 4.0845070422017455 , 100 , .4 );	
  Drive.turn( 137 , 100 , .9 );	
  Drive.moveDistance( -21.239436619449076 , 100 , 1.1 );	
  Drive.turn( 145 , 100 , .9 );	
  task C2 = task(testClamp2);
  Drive.moveDistance( -10.211267605504364 , 100 , .7 );	
  Drive.turn( -78.00393288339313+360 , 100 , .8 );	
  intake.spin(fwd, 100, pct);
  Drive.moveDistance( 22.4647887321096 , 100 , .8 );
...
void blueNegElim(){
  intake.spin(fwd,100, pct);
  Drive.moveDistance( 21.647887323669252+4.901408450642095 , 80 , 1);	
  intake.stop();
  Drive.turn( 90 , 100 , .65 );	
  task C1 = task(testClamp);
  Drive.moveDistance( -17.15492957724733 , 100 , .85 );	
...
void bluePosElim(){
  ...
  Drive.swing(36, 100, -12, .92);
  Drive.moveDistance(-6, 100, .45);
  bonk.close();
  Drive.moveDistance(4, 100, .35);
  Drive.turn(-53, 100, .5);
  task C1 = task(clamp1BPE);
  Drive.swing(-11, 100, -90, 1.1);
  intake.spin(fwd, 100, pct);
  Drive.moveDistance(16, 100, .77);
  clamp.close();
  Drive.moveDistance(-12, 100, .75);
  intake.stop();
  Drive.turn(-195, 100, .85);
  task C2 = task(clamp2BPE);
  Drive.moveDistance(-16.5, 100, .8);
  intake.spin(fwd, 100, pct);
  task CO1 = task(openClampBPE);
  task bCont = task(goofyBonkBPE);
  Drive.swing(56, 100, -90, 1.8);
  bonk.open();
  wait(.15, sec);
  ...
  // task lbsetting = task(lbSet);
  Drive.moveDistance(10, 100, .7); 
  Drive.turn(36, 100, .45);
  Drive.moveDistance(25, 100, .86);
  intake.stop();
  Drive.turn(-49, 100, .7);
  // task C2 = task(clamp2BPE);
  // Drive.swing(-29, 100, 100, 1.3);
  // Drive.turn(210, 100, .8);
  // intake.spin(fwd, 100, pct);
  Drive.swing(17.8, 100, -52, .77);
...
<<<<<<< Updated upstream
    //Optical.setLightPower(70, percent);
=======
    Optical.setLightPower(20, percent);
>>>>>>> Stashed changes
    // con.Screen.clearScreen();
    // con.Screen.setCursor(1,1);
