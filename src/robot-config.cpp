...
pneumatics rushArm = pneumatics(Brain.ThreeWirePort.B);
pneumatics ringRush = pneumatics(Brain.ThreeWirePort.E);
pneumatics iLift = pneumatics(Brain.ThreeWirePort.A);
/**
